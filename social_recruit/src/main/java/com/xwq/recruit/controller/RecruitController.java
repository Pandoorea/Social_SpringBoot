...
import com.xwq.recruit.pojo.Recruit;
import com.xwq.recruit.service.RecruitService;
...
public class RecruitController {
	...
	public Result recommend(){
		return new Result(true,StatusCode.OK,"",recruitService.recommend());
	}
	/**
	 * 查询最新职位
	 * @return
	...
	public Result newlist(){
		return new Result(true,StatusCode.OK,"",recruitService.latestList());
	}
